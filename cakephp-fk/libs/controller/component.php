 ...
 */
	function _loadComponents(&$object, $parent = null) {
        ...
        if ($parent == null) {
			/* FLIPKEY EDIT - This line automatically ads the session component to every page
                wich makes taking it off for widgets a challenge.  Since it's included in the app_controller
