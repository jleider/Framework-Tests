 ...
 */
	function tagIsInvalid($model = null, $field = null, $modelID = null) {
        ...
        if ($errors['HoldingProperty'])
        {
            $errors['Holding_property'] = $errors['HoldingProperty'];
            unset($errors['HoldingProperty']);
        }
        
        //if ($view->model == "Holding_property") $view->model = "HoldingProperty";
        //debug($view->model);
