	...
	function remoteFunction($options) {
		if (isset($options['update'])) {
			if (!is_array($options['update'])) {
				// FLIKEY EDIT - So we should alllways use the flipkey override of the prototype ajax methods
                $func = "FlipKey.Ajax.updater('{$options['update']}',";
                // END FLIPKEY EDIT
			} else {
                // FLIKEY EDIT - So we should alllways use the flipkey override of the prototype ajax methods
				$func = "FlipKey.Ajax.updater(document.createElement('div'),";
                // END FLIPKEY EDIT
			}
